...
(function () {
  ...
  function showRoleError(form, message) {
    var field = form.querySelector('.role-select');
  ...
  if (loginForm) {
    ...
    loginForm.addEventListener('submit', function (e) {
      ...
      var role = loginForm.querySelector(
